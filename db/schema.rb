...
ActiveRecord::Schema.define(version: 2021_01_05_092014) do
  ...
  create_table "addresses", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["order_information_id"], name: "index_addresses_on_order_information_id"
  end
  ...
  create_table "order_informations", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["item_id"], name: "index_order_informations_on_item_id"
  ...
  add_foreign_key "addresses", "order_informations"
  add_foreign_key "items", "users"
  add_foreign_key "order_informations", "items"
